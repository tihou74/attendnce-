...
// v169: حقولُ العباية — القماشُ يكتبه المالك، وذهبيّ/فضّيّ وإمكانُ الأوردر تختارهما السيدة فاطمة.
// v168: كتالوجٌ لكلِّ الأصناف — نوعُ القطعة على سطر الكتالوج، يُنقل من الشحنة ويُرشَّح به.
// v167: شاشةُ ترحيبٍ كحليةٌ بخطٍّ ذهبيّ: «أهلًا وسهلًا السيدة فاطمة، هناك بضاعةٌ جديدةٌ وصلت».
// v166: كريميٌّ وبيجٌ بحوافَّ عنابيةٍ في لوحة السيدة فاطمة — كلاسيكيٌّ، و23 زوجَ تباينٍ مقيس.
// v165: إعادةُ تصميم بطاقة «وصل حديثًا» — الصورةُ بطلةُ البطاقة، ومقاساتٌ وسومًا،
//       وكوستٌ بارزٌ، وقراءةُ ربحٍ حيّةٌ وهي تكتب السعر.
// v164: صورةُ الشحنة تُفتح كاملةً بالضغط في لوحة السيدة فاطمة.
// v163: «السيز المتوفر» — مقاسٌ على الشحنة وعلى سطر الكتالوج، تقرؤه البياعة.
// v162: «بضاعة جديدة وصلت» — تسجيلُ الشحنة بأرقام شرائها، وإرسالُ السيدة فاطمة
//       لها إلى متجرٍ بسعرِ بيعٍ تضعه هي. وأوّلُ صلاحيةِ كتابةٍ تملكها (قواعد v16).
// v161: خانةٌ واحدةٌ للبطاقة الشخصية باسم «Qatar ID (Metrash)»، وإزالةُ خانة الظهر.
// v160: إصلاحُ رفعِ مستندِ موظفٍ على ملفِّ موظفٍ آخر، ومنعُ محوِ صورةٍ محفوظة.
...
const SHELL_FILES = [
    ...
    //
    // ⚠️⚠️⚠️ العنوانان معًا بقصد، وهذا إصلاحُ عطلٍ حقيقيّ: الصفحاتُ تطلبه الآن
    // بـ?v=<CACHE_VERSION> لأنّ ألوانها كلَّها منه، فيجب أن يتغيّر معها في
    // اللحظة نفسها. وقياسُ النسخة المنشورة أظهر صفحةً جديدةً مع نسخةٍ قديمةٍ
    // من هذا الملفّ، فصارت كلُّ الأسطح شفّافةً — لوحةٌ تبدو مهدومة. فيُخزَّن
    // العنوانُ المُرقَّم (وهو ما تطلبه الصفحات فعلًا)، ويُخزَّن العنوانُ
    // المجرَّد كذلك لأنّ صفحاتٍ أقدمَ ما زالت تطلبه بلا رقم — وإسقاطُ أحدهما
    // يُفقد التنسيقَ في وضع عدم الاتصال لإحدى المجموعتين.
    './brand/design-tokens.css',
    `./brand/design-tokens.css?v=${CACHE_VERSION.replace('v', '')}`,
