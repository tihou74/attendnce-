...
LOGO_APPS = [
    # خلفية بيضاء بطلب الإدارة: الشعار الذهبي على أبيض هو تقديمه الأصلي.
    # وهي تبقى مميّزة عن الثلاثة الأخرى لأن الأبيض لا يشتبه بالكحلي ولا الأزرق
    # ولا الأخضر — فالتمييز محفوظ بلا لون إضافي.
    ('admin', (255, 255, 255), 'لوحة الإدارة — أبيض + شعار مجموعة الشيخة الذهبي'),
]
